...
#define AI_CNN_ORIGIN_MODEL_NAME   "best_shallow_cnn_model"
...
#define AI_CNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_IN_1_HEIGHT      (64)
#define AI_CNN_IN_1_WIDTH       (64)
#define AI_CNN_IN_1_CHANNEL     (1)
#define AI_CNN_IN_1_SIZE        (4096)
#define AI_CNN_IN_1_SIZE_BYTES  (16384)
...
#define AI_CNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_CNN_OUT_1_CHANNEL     (1)
#define AI_CNN_OUT_1_SIZE        (1)
#define AI_CNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_CNN_N_NODES (8)
